            ...
            <section class="sections">
                ...
                <div class="boxr">
                    <form action="index.php" method="POST">
                        <legend>Add Registro</legend>
                            <?php
                                include_once('config.php');
                                if(isset($_POST['submit']))
                                {
                                    $conteudos = addslashes($_POST['conteudos']);
                                    $result = mysqli_query($conexao, "INSERT INTO historico (conteudos) VALUES ('$conteudos')");
                            ?>
                        ...
                        <div class="inputBox">
                            ...
                            <label for="conteudos" class="labelRInput">Escreva o próximo registro...</label>
                        </div>
