            ...
            <section class="sections">
                ...
                <div class="boxr">
                    <form action="index.php" method="POST">
                            <legend>Add Regra</legend>
                                <?php
                                    include_once('config.php');
                                    if(isset($_POST['submit']))
                                    {
                                        $conteudos = addslashes($_POST['conteudos']);
                                        $result = mysqli_query($conexao3, "INSERT INTO regras (conteudos) VALUES ('$conteudos')");
                                ?>
                            ...
                            <div class="inputBox">
                                ...
                                <label for="conteudos" class="labelRInput">Escreva a próxima regra...</label>
                            </div>
